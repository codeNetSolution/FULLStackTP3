...
const ShopForm = () => {
    ...
    const handleChange = (index: number, key: string, value: any) => {
        ...
        if (key === 'day') {
            ...
            openingHours[index] = {
                ...openingHours[index],
                [key]: value ? (value as Dayjs).format('HH:mm:ss') : '',
            };
        }
    ...
    const handleClickAddHours = () => {
        setShop({
            ...
            openingHours: [
                ...shop.openingHours,
                { day: 1, openAt: dayjs('09:00:00').format('HH:mm:ss'), closeAt: dayjs('18:00:00').format('HH:mm:ss') },
            ],
        });
    };
                                ...
                                >
                                    ...
                                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                                        <TimePicker
                                            ...
                                            onChange={(v) => handleChange(index, 'openAt', v)}
                                            slotProps={{
                                                textField: {
                                                    fullWidth: true,
                                                },
                                    ...
                                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                                        <TimePicker
                                            ...
                                            onChange={(v) => handleChange(index, 'closeAt', v)}
                                            slotProps={{
                                                textField: {
                                                    fullWidth: true,
                                                },
